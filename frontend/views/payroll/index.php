...
$types = PayslipDeductionTypes::find()->all();
$columns = []; 
...
$columns[]=[
    ...
    'filter' =>\yii\helpers\ArrayHelper::map(Employees::find()->all(), 'id', 'fulllist'),
    'filterWidgetOptions' => [
            'pluginOptions' => ['allowClear' => true],
        ],
        'filterInputOptions' => ['placeholder' => '...'],
    'value'=>function($model){
        return $model->emp->firstname.' '.$model->emp->lastname;
    }
];
$columns[]=[
    'label'=>'Gross Income',
    ...
    $(document).ready(function(){
        $(".createjev").click(function(){
            ...
            if((selection.length)>0&&transaction_date!=null){
               ...
               if(x==true){
                    $.ajax({
                          url    : '/pos/frontend/web/payroll/createjev',
                          type   : 'POST',
        ...
        $(".createpcv").click(function(){
            ...
            if((selection.length)>0&&transaction_date!=null){
               ...
               if(x==true){
                    $.ajax({
                          url    : '/pos/frontend/web/payroll/createpcv',
                          type   : 'POST',
                          data   : {selection:selection,transaction_date:transaction_date},
                      });
               } 
