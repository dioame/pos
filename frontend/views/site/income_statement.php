		...
		<table id="exportTable" width="100%" border="0" style="">
			<tr>
				<td class="center" colspan="12" style="border-left: 0px;border-right: 0px;padding: 0px;">
					...
					<h3 style="margin:0px;">Income Statement</h3>
					<br>
				</td>
			</tr>
			<tr>
				...
				<td>
					<table width="100%">
						<tr>
							...
							<td class="rightni"><b><hr style="border-color:black;padding: 0px;margin: 0px;"><?= number_format($totalsales-$totalexpense,2) ?><hr style="border-color:black;padding: 0px;margin: 0px;"><hr style="border-color:black;padding: 0px;margin-top: 4px;"></b></td>
						</tr>
					</table>
				</td>
			</tr>
