...
$this->title = 'PCV#'.$model->pcv_number;
$this->params['breadcrumbs'][] = ['label' => 'Petty Cash Disbursement Journal', 'url' => ['index']];
...
<div class="dv-tracking-form">
    ...
    <div class="row">
        ...
        <div class="col-md-offset-1 col-md-10 col-md-offset-1">
            ...
            <?= Settings::find()->where(['attribute'=>'address'])->one()->value ?><hr><h3>Petty Cash Voucher</h3></center>
            <div class="col-md-offset-9 col-md-3">
                <span class="pull-right"><label>PCV #: </label><?= $model->pcv_number ?></span>
            </div>
