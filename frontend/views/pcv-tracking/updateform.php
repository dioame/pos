    ...
    <div class="row">
        ...
        <div class="col-md-offset-1 col-md-10 col-md-offset-1">
            ...
            <div class="col-md-offset-9 col-md-3">
                <span><?= $form->field($model, 'pcv_number')->textInput(['style'=>'text-align:right;','maxlength' => true,'value'=>($model->pcv_number?$model->pcv_number:DvTracking::getNewdvnumber())]) ?></span>
            </div>
                        ...
                        <td rowspan="3">
                            <?php
                                echo $form->field($model, 'prepared_by')->widget(Select2::classname(), [
                                    'data' => ArrayHelper::map(Officers::find()->all(), 'id', 'fulllist'),
            ...
            <?= $form->field($model, 'debit')->hiddenInput(['value'=>$model->debit])->label(false) ?>

            <?= $form->field($model, 'credit')->hiddenInput(['value'=>$model->credit])->label(false) ?>
